...
/**
 * convert ACF text field to shortcode. Allows me to add short codes in custom post types that can then be dynamically inserted in Elementor  
 */
...
if ( get_field('icon_list_and_map') ) {
	echo do_shortcode( get_field('icon_list_and_map') );
}

if ( get_field('booking_form') ) {
	echo do_shortcode( get_field('booking_form') );
}

/**
 * custom queries to sort posts
 */

 add_action('elementor/query/order_by_price', function($query){
